...
export default function Sertificates() {
  return (
    <section className="w-[80%] flex flex-col gap-4 items-center justify-between">
      <h2 className="text-cherry text-[32px] text-left w-full pl-6 font-bold pb-10">
      ...
      <ul className="flex w-full justify-evenly">
        <li className="w-[30%] flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-8">
            <h3 className="text-[24px] font-bold text-orange">ISO/IEC 27001:2022</h3>
            <p className="flex flex-col gap-4">
              ...
              <span className="text-cherry font-semibold hover:underline">Learn more</span>
            </p>
          </div>
        </li>
        <li className="w-[30%] flex flex-col gap-4">
