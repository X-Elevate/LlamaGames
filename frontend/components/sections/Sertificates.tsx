...
export default function Certificates() {
    return (
        <section
            id="licensing"
            className='section-offset w-full px-4 sm:px-8 md:w-[90%] lg:w-[80%] mx-auto flex flex-col gap-4 items-center justify-between z-200'
        >
            ...
            <ul className='flex flex-col sm:flex-row w-full justify-evenly gap-8 sm:gap-4'>
                {[1, 2, 3].map((item) => (
                    <li
                        key={item}
                        className='w-full sm:w-[30%] flex flex-col gap-4'
                    >
                        ...
                        <div className='flex flex-col gap-4 sm:gap-8'>
                            ...
                            <p className='flex flex-col gap-4'>
                                <span className='text-darkCherry text-sm sm:text-base'>
                                    Llama Game Technology is accredited with the
                                    ISO/IEC 27001:2013, which specifies the
